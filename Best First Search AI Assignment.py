...
Romania_Graph = { 'Arad':[['Zerind',374],['Timisoara',329],['Sibiu',253]],
         ...
         'Criova':[['Pitesti',98],['Dobreta',242],['Rimniciu Vilcea',193]],
...
def gbfs(Romania_Graph, start, end):
    explored = []
    queue = [start]
    while queue:
        print (queue)
